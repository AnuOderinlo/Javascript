...
// Number.parseInt is used to get a number out of the string if the  string starts with a number though
console.log(Number.parseInt('30px'));
console.log(Number.parseInt('e30'));
// console.log(Number.isNaN('eqw30'));
// console.log(Number.isNaN('30px'));
console.log(Number.isNaN('good'));
console.log(isNaN('good'));
// console.log(Number.isNaN(30));


//The best way to check a real number
...
//Random numbers btw two values min and max
...
const date1 = new Date(2022, 4, 24) / (1000 * 60 * 60 * 24);
const date2 = new Date(2022, 4, 10) / (1000 * 60 * 60 * 24);

console.log(Math.abs(date2 - date1));
*/

const num = 2345832.88;
